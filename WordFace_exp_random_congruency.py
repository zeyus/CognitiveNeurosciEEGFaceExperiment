...
"""
# Monitor parameters
MON_DISTANCE = 40  # Distance between subject's eyes and monitor 
...
V= {'ID':'','exp type':['fMRI','MEG','behavioural'],'session':[1,2,3,4,5,6],'Scan day': ['Tuesday','Wednesday'],'gender':['female','male','other'],'age':''}
...
faces=(IMG_P,IMG_N)
delays=(60,120)# different time intervals between stimuli mean 4.1 sec x 60 hz refresh rate =246, in order to make less predictable and increase power.
...
hest=make_trial_list('WordFace_exp_random_congruency')
